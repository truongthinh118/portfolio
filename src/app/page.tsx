      ...
      <div className="col-span-5 row-span-3 flex px-10">
        <div className="m-auto flex h-full flex-col justify-evenly gap-6 py-4">
          <Card className="overflow-visible rounded-md border border-[#7A7673] shadow-md">
            <span className="absolute top-[50%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-default from-50% via-transparent via-50% p-1">
              <svg
            ...
            <span className="absolute left-12 -translate-y-1/2 bg-gradient-to-b from-default from-50% via-transparent via-50% px-1 text-3xl font-bold">
              Objectives
            </span>
